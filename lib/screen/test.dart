...
class JustAjay extends StatefulWidget {
  const JustAjay({super.key});

  @override
  JustAjayState createState() => JustAjayState();
}

class JustAjayState extends State<JustAjay> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await player.setSource(UrlSource('https://influenza-laravel.onrender.com/shiva.mp3'));
      await player.resume();
    });
  }
